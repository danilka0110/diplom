            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                    <div class="card" style="border-radius: 50px;">
                        ...
                        <h2 class="text-uppercase text-center mb-5">Новый пароль</h2>
                        <form action="newpass" method="get" class="sign_form">
                            ...
                            <button type="submit" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body" name="change">Восстановить</button>
                            </div>
                        </form>
                        </div>
                    </div>
