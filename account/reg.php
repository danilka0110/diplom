        ...
        <div class="col-md-6 contents">
          <div class="row justify-content-center">
            ...
            <form action="reg" method="POST" class="sign_form">
                ...
                <div class="form-outline mb-4">
                    <input required type="password" class="form-control form-control-lg" placeholder = "Повторите пароль" name="password_2" maxlength="32">
                </div>
                ...
                ?>      
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-acc btn-lg" name="reg">Регистрация</button>
                        </div>
