                                    ...
                                    <div class="card" style="width: 33,33333%;">
                                        <div class="card-body">
                                            <?php foreach ($popular_tests as $popular_test) :?>
                                                <div class="row">
                                                    <div class="col-xs-4 col-sm-3 col-md-2 col-lg-2 col-xl-2 mt-2">
                                                        <a href="test?test=<?=$popular_test['id']?>"><img src="<?=$popular_test['img_link']?>" class="card-img-test popular_test_img" alt="..."></a>
                                                    </div>
                                                    <div class="col-xs-8 col-sm-9 col-md-10 col-lg-10 col-xl-10 mt-3">
                                                        <a href="test?test=<?=$popular_test['id']?>" class="mt-2"><?=$popular_test['test_name']?></a>
                                                    </div>        
                                                </div>
                                            <?php endforeach ;?>
                                        </div>
