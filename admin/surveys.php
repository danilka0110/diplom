...
<?php 
    ...
    $closed_surveys = R::getAll("SELECT *
    FROM survey
        WHERE enable = '0'");
        ...
        <div class="container">
            <div class="main-body">
                ...
                <div class="mt-4 text-center">
                    <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#btn-delete">Удалить существующий опрос</a>
                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="surveys" method="POST">
                                <div class="modal-body">
                                    <span>Введите ID опроса, который хотите удалить</span>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text">ID</span>
                                        <input type="text" class="form-control" name="survey_id" placeholder="ID" value="<?=$test_id?>">
                                    </div>
                                </div>
                ...
                <h2 class="mt-4 text-center">Новые опросы:</h2>
                ...
                <div class="row mt-4">
                    <?php foreach($closed_surveys as $survey):?>

                        <?php 
                            $survey_author = R::findOne('users', 'id = ?',[$survey['user_id']]);
                        ?>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 sidenav-item sidenav-link elastic">
                                ...
                                <div class="card card-test">
                                    ...
                                    <a href="survey?survey=<?=$survey['id']?>">
                                    ...
                                    <div class="test-author-for-img mt-1 text-center">
                                        ...
                                        <?php if($survey_author->img_link): ?>

                                            <img src="<?=$survey_author->img_link?>" alt="author.png" style="width:18px; height: 18px; object-fit: cover; border-radius: 50%;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-center">
                                            <a href="survey?survey=<?=$survey['id']?>" class="btn btn-primary btn-test">Посмотреть</a>
                                        </div>
                                    </div>
                                </div>   
