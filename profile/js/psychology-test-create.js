...
$(document).on('click', '.addResult', function() {
    ...
    <textarea name="result_${resultNum}" id="result_1" class="form-control" placeholder="Результат #${resultNum}"></textarea>
    </div>
    <div class="row">
        <div class="col-6 col-md-6 col-lg-6 col-xl-6 mt-2">
            <label for="result_score_min_${resultNum}" class="form-label">Балл (от)</label>
            <input type="text" name="result_score_min_${resultNum}" id="result_score_min_${resultNum}" class="form-control" placeholder="Балл (от)">
        </div>
        <div class="col-6 col-md-6 col-lg-6 col-xl-6 mt-2">
            <label for="result_score_max_${resultNum}" class="form-label">Балл (до)</label>
            <input type="text" name="result_score_max_${resultNum}" id="result_score_max_${resultNum}" class="form-control" placeholder="Балл (до)">
        </div>
    </div>
</div>`);
});
