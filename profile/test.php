    ...
    <div class="container"> 
        <div class="main-body">
            ...
            <div class="btns-nav-tests-block text-center">
                    ...
                    <button type="button" class="btn btn-outline-primary btn-show-profile-tests btn-show-my-tests-in-profile"><span>Мои тесты</span></button>
            ...
            <div class="my-tests">
                ...
                <div class="row mt-4">
                    <?php foreach($tests as $test):?>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 sidenav-item sidenav-link">
            ...
            <div class="my-passes-tests">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-8 offset-xl-2 mb-3">
