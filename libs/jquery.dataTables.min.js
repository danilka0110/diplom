...
sNext:"Дальше",sPrevious:"Назад"},sEmptyTable:"Нет данных",sInfo:"Показано от _START_ до _END_ из _TOTAL_ возможных",sInfoEmpty:"От 0 до 0 из 0 записей",sInfoFiltered:"(отфильтровано из _MAX_ вариантов)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показать _MENU_ строк",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Поиск:",sSearchPlaceholder:"Поиск",sUrl:"",sZeroRecords:"Не найдено ни одного варианта"},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
